...
public class Member extends org.jooq.impl.TableImpl<tech.codingclub.helix.tables.records.MemberRecord> {
	...
	private static final long serialVersionUID = 321222833;
	 ...
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.MemberRecord, java.lang.String> EMAIL = createField("email", org.jooq.impl.SQLDataType.VARCHAR, this, "");
	...
	/**
	 * The column <code>public.member.age</code>.
	 */
	public final org.jooq.TableField<tech.codingclub.helix.tables.records.MemberRecord, java.lang.Long> AGE = createField("age", org.jooq.impl.SQLDataType.BIGINT, this, "");
	...
	public org.jooq.UniqueKey<tech.codingclub.helix.tables.records.MemberRecord> getPrimaryKey() {
		return tech.codingclub.helix.Keys.UNIQUE_ID;
	}
	...
	public java.util.List<org.jooq.UniqueKey<tech.codingclub.helix.tables.records.MemberRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<tech.codingclub.helix.tables.records.MemberRecord>>asList(tech.codingclub.helix.Keys.UNIQUE, tech.codingclub.helix.Keys.UNIQUE_ID);
	}
