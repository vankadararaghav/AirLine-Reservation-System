...
public class ControllerUtils {
    ...
    public static Boolean isUserAdmin(HttpServletRequest httpServletRequest){
        Boolean temp = (Boolean) httpServletRequest.getSession().getAttribute("admin");
    ...
    public static Boolean isUserUser(@NotNull HttpServletRequest httpServletRequest) {
        Boolean temp = (Boolean) httpServletRequest.getSession().getAttribute("user");
