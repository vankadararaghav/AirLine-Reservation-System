...
<body>
    <div class="containerx">
       <table class="default" border="0" cellpadding="3" cellspacing="0" height="300px" width="100%">
          <caption><span class="hidden"> Boston to Portland, OR </span></caption>
          <tbody>
             <tr>
                <th colspan="1" style="width: 15px;" scope="col">
                   PassengerName
                </th>
                <th colspan="1" style="width: 15px;" scope="col">
                   email
                </th>
                <th rowspan="1"  style="width: 15px;">
                   phoneNumber
                </th>
                <th colspan="1" style="width: 15px;" scope="col">
                   Flight
   ...
   <script type="text/javascript">
     ...
     $(".ticket").click(function(){
       ...
       var id = this.getAttribute("id");
        window.location.href = "/user/ticket_show?id="+id;
     });
   </script>
   </body>
</html>